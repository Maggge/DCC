...
public:
  ...
  static void setThrottle(uint16_t cab, uint8_t tSpeed, uint8_t tSpeedSteps, bool tDirection);
  ...
  static unsigned long getFns(int cab);
  ...
  static uint8_t getSpeedSteps(int cab);
